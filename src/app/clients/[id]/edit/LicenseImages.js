  ...
  const imageSlots = [
    {
      ...
      icon: CreditCard,
      placeholder: 'رفع صورة رخصة القيادة الأمامية'
    },
    {
      key: 'licenseBack',
      label: 'رخصة القيادة - الوجه الخلفي',
      icon: CreditCard,
      placeholder: 'رفع صورة رخصة القيادة الخلفية'
    }
  ]
    ...
    <div className="my-4">
      <div className="">
        ...
        <div className="flex justify-between items-center mt-4">
          <span className="text-sm text-gray-500">تم رفع {uploadedCount} من 2 صورة</span>
          {uploadedCount > 0 && (
            <button
