...
function LastWeekSessions() {
    ...
    if (isLoading) {
        return (
            <div className="flex flex-col h-full">
                <div className='flex items-center gap-3 px-4 py-3 mb-4 rounded-lg bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-l-4 border-blue-500 shadow-sm'>
    ...
    return <div className="flex flex-col h-full">
        <div className='flex items-center gap-3 px-4 py-3 mb-4 rounded-lg bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-l-4 border-blue-500 shadow-sm hover:shadow-md transition-all duration-300'>
            <div className='flex-1'>
                <h3 className='text-sm sm:text-base font-semibold text-blue-900 dark:text-blue-100'>
                    {t('home.weekSessions')}
                </h3>
        ...
        <div className="flex-1 bg-gray-50 dark:bg-gray-800 rounded-lg space-y-3 p-4 shadow-sm hover:shadow-md transition-all duration-300 overflow-y-auto max-h-[600px]">
            {sessions.length === 0 ? (
                <div className="flex items-center justify-center h-full min-h-[200px] text-center text-gray-500 dark:text-gray-400 py-4">{t('home.noSessionsThisWeek')}</div>
            ) : (
