        ...
        <div className="space-y-3">
          ...
          {displayFileNumber && (
            <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <span>{t('home.fileNumber')}:</span>
              <span className="font-medium text-gray-900 dark:text-gray-100">{displayFileNumber}</span>
            </div>
          )}
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <span>{t('home.ruling')}:</span>
            <span className="font-medium text-purple-900 dark:text-purple-300">{displayRuling}</span>
          </div>
            ...
            <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
              <div className="space-y-2">
                ...
                {session?.has_objection && (
                  <div className="flex items-center justify-between p-2.5 rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-950/30 hover:bg-blue-50 dark:hover:bg-blue-950/50 transition-colors">
                    <div className="flex items-center gap-2">
                      <div className="p-1 bg-blue-500 rounded">
                        <FileText className="w-3.5 h-3.5 text-white" />
                      </div>
                      <div>
                        <div className="text-xs font-semibold text-blue-900 dark:text-blue-100">{t('home.lastDateFor')} {t('home.objection')}</div>
                        <div className="text-xs text-blue-700 dark:text-blue-300">{formatDate(session.objection_end_date)}</div>
                      </div>
                    </div>
                    {objectionInfo && (
                      <div className="flex items-center gap-1.5">
                        <div className="relative">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold text-white shadow-lg relative z-10 ${
                ...
                {/* Appeal (استئناف) */}
                {session?.has_appeal && (
                  <div className="flex items-center justify-between p-2.5 rounded-lg border border-purple-200 dark:border-purple-800 bg-purple-50/50 dark:bg-purple-950/30 hover:bg-purple-50 dark:hover:bg-purple-950/50 transition-colors">
                    <div className="flex items-center gap-2">
                      <div className="p-1 bg-purple-500 rounded">
                        <Scale className="w-3.5 h-3.5 text-white" />
                      </div>
                      <div>
                        <div className="text-xs font-semibold text-purple-900 dark:text-purple-100">{t('home.lastDateFor')} {t('home.appeal')}</div>
                        <div className="text-xs text-purple-700 dark:text-purple-300">{formatDate(session.appeal_end_date)}</div>
                      </div>
                    </div>
                    {appealInfo && (
                      <div className="flex items-center gap-1.5">
                ...
                {session?.has_cassation && (
                  <div className="flex items-center justify-between p-2.5 rounded-lg border border-red-200 dark:border-red-800 bg-red-50/50 dark:bg-red-950/30 hover:bg-red-50 dark:hover:bg-red-950/50 transition-colors">
                    <div className="flex items-center gap-2">
                      <div className="p-1 bg-red-500 rounded">
                        <AlertTriangle className="w-3.5 h-3.5 text-white" />
                      </div>
                      <div>
                        <div className="text-xs font-semibold text-red-900 dark:text-red-100">{t('home.lastDateFor')} {t('home.cassation')}</div>
                        <div className="text-xs text-red-700 dark:text-red-300">{formatDate(session.cassation_end_date)}</div>
                      </div>
                    </div>
                    {cassationInfo && (
                      <div className="flex items-center gap-1.5">
