...
export default function RecentRentals({ rentals }) {
  return (
    <Card className="mb-8">
      <CardHeader>
        <CardTitle className="text-xl font-semibold text-gray-900">الإيجارات الأخيرة</CardTitle>
        <p className="text-gray-600 mt-1">أحدث معاملات الإيجار وحالتها</p>
      </CardHeader>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {rentals.map((rental) => (
              <tr key={rental.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm font-medium text-gray-900">{rental.vehicle}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-900">{rental.startDate}</div>
                  <div className="text-sm text-gray-500">إلى {rental.endDate}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm font-medium text-gray-900 flex items-center gap-1">
                    ...
                    <svg className='w-4 h-4' xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 1000 870" >
