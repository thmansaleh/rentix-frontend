...
const AEDIcon = () => (
  <svg className='w-8 h-8 text-blue-600' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 870" >
...
export default function StatsCards() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      />
      <StatCard
        title={tDashboard('activeContracts')}
      ...
      />
      <StatCard
        title={tDashboard('monthlyRevenue')}
      ...
      />
      <StatCard
        title={tDashboard('availableCars')}
        value={mockStats.availableVehicles}
        icon={Calendar}
        change="-3%"
        changeType="down"
      />
