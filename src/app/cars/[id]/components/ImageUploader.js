...
import { setCarImages, addCarImage, removeCarImage } from '@/redux/slices/editCarSlice'
import ButtonImagesSend from './send-buttons/ButtonImagesSend'

function ImageUploader() {
  const t = useTranslations();
  
  const dispatch = useDispatch()
  const images = useSelector(state => state.editCar?.carImages || [])
