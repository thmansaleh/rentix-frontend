...
import { setPurchaseDate, setPurchasePrice } from '@/redux/slices/editCarSlice'
import ButtonPurchaseSend from './send-buttons/ButtonPurchaseSend'
          ...
          <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className="w-full justify-start text-left font-normal">
                  ...
                  <span className="ml-2">{formatDate(editCar.purchase_date) || t('cars.carAddForm.purchase.selectDate')}</span>
                </Button>
              </PopoverTrigger>
            <PopoverContent className="w-auto p-0" align="start">
              <Calendar
                mode="single"
                  selected={editCar.purchase_date ? new Date(editCar.purchase_date) : undefined}
