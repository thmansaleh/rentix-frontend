          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" className="w-full justify-start text-left font-normal">
                ...
                <span className="ml-2">{formatDate(addCar.last_maintenance_date) || t('cars.carAddForm.maintenance.selectDate')}</span>
              </Button>
            </PopoverTrigger>
            <PopoverContent className="w-auto p-0" align="start">
              <Calendar
                mode="single"
                selected={addCar.last_maintenance_date ? new Date(addCar.last_maintenance_date) : undefined}
        ...
        <div className="space-y-2">
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" className="w-full justify-start text-left font-normal">
                <CalendarIcon className="ml-2 h-4 w-4" />
                <span className="ml-2">{formatDate(addCar.next_maintenance_date) || t('cars.carAddForm.maintenance.selectDate')}</span>
              </Button>
            </PopoverTrigger>
            <PopoverContent className="w-auto p-0" align="start">
              <Calendar
                mode="single"
                selected={addCar.next_maintenance_date ? new Date(addCar.next_maintenance_date) : undefined}
        ...
        <div className="space-y-2">
          ...
          <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className="w-full justify-start text-left font-normal">
                  <CalendarIcon className="ml-2 h-4 w-4" />
                  <span className="ml-2">{formatDate(addCar.insurance_expiry) || t('cars.carAddForm.maintenance.selectDate')}</span>
                </Button>
              </PopoverTrigger>
            <PopoverContent className="w-auto p-0" align="start">
              <Calendar
                mode="single"
                selected={addCar.insurance_expiry ? new Date(addCar.insurance_expiry) : undefined}
