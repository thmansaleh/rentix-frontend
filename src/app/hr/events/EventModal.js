...
import { createEvent, updateEvent } from '@/app/services/api/events'
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        toast.success(isArabic ? 'تم إنشاء الحدث بنجاح' : 'Event created successfully')
      }
        ...
        <DialogHeader>
          <DialogTitle>
            {isEditMode 
              ...
              : (isArabic ? 'إضافة حدث جديدة' : 'Add New Event')
            }
          </DialogTitle>
        </DialogHeader>
